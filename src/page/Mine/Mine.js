        ...
        <LinearGradient
          ...
          <View style={{padding: 24, flexDirection: 'row'}}>
            ...
            <View style={{marginLeft: 16, paddingTop: 4, paddingBottom: 4}}>
              ...
              <TouchableOpacity style={[styles.mine_userinfo_btn]}>
                <Text style={{color: constant.text_white}}>{`个人主页 >`}</Text>
              </TouchableOpacity>
            </View>
          </View>
          <View style={[styles.mine_grid_box]}>
            <TouchableOpacity
              ...
              <Text style={{color: constant.text_white, fontSize: 20}}>1</Text>
            ...
            <TouchableOpacity
              ...
              <Text style={{color: constant.text_white, fontSize: 20}}>14</Text>
            ...
            <TouchableOpacity
              ...
              <Text style={{color: constant.text_white, fontSize: 20}}>4</Text>
